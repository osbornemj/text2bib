...
&nbsp;&bull;&nbsp;
{{ $conversion->use_crossref ? 'check Crossref.org' : 'don\'t check Crossref.org' }}
&nbsp;&bull;&nbsp;
...
@if ($conversion->use_crossref)
  ...
  <div class="ml-4">
    ...
    @if ($conversion->crossref_count > 0 || $conversion->crossref_cache_count > 0)
      <br/>
      When algorithm and Crossref.org disagree, <span class="text-blue-700 dark:text-blue-300">text</span> = generated by algorithm, <span class="text-orange-800 dark:text-orange-300">text</span> = obtained from Crossref.org.  Use radio buttons to select version you want.
    @endif
  </div>
@endif
