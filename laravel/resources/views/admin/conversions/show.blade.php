    ...
    <div class="sm:px-0 pt-4 space-y-6">
        <div class="px-4 sm:rounded-lg">
            <div class="ml-0">
                ...
                <div class="mt-1">
                    <span class="inline-block bg-teal-200 dark:bg-emerald-300 dark:text-teal-800 text-xs px-2 py-1 uppercase font-semibold tracking-wide rounded">Examined {{ $conversion->examined_at }}</span> [<x-link href="{{ url('admin/conversionUnexamined/' . $conversion->id) }}">remove</x-link>]
                </div>
                @else
