...
class ExampleSeeder extends Seeder
{
    public function run(): void
    {
        $examples = [
            ...
            [
                'source' => 'Артемова Т.И. Стоимость и цена: логико-исторический процесс формообразования. К.: Основа, 2006. 448 с. ',
                'type' => 'book',
                'bibtex' => [
                    'author' => 'Артемова, Т. И.',
                    'pagetotal' => '448',
                    'publisher' => 'Основа',
                    'address' => 'К.',
                    'title' => 'Стоимость и цена',
                    'subtitle' => 'Логико-исторический процесс формообразования',
                    'year' => '2006',
                    ]
            ],
            [
