...
//            $entry = rtrim($entry, ' }');  // don't remove }: might end a TeX macro like \doi
        ...
        switch ($itemKind) {
            ...
            case 'inproceedings':
                ...
                if ($result && is_array($result) && isset($result['after']) && Str::startsWith($result['after'], ')')) {
                ...
                // If $remainder consists only of letters and spaces, is booktitle if no booktitle has been found
                // and is publisher if no publisher has been found
