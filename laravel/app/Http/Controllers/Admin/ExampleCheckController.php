...
class ExampleCheckController extends Controller
{
    ...
    public function runExampleCheck(Request $request, string $reportType = 'brief', string $language = 'en', string $detailsIfCorrect = 'hide', int $id = 0, string $charEncoding = 'utf8', string $use = 'biblatex'): View
    {
